...
import { EditableContentProvider } from "@/components/editor/EditableContentContext";
import ContentEditorModal from "@/components/editor/ContentEditorModal";

const editorEnabled =
  process.env.NODE_ENV !== "production" ||
  process.env.NEXT_PUBLIC_ENABLE_CONTENT_EDITOR === "true";
...
export default function LandingPageContent() {
  return (
    <EditableContentProvider>
      ...
      <ContentEditorModal enabled={editorEnabled} />
    </EditableContentProvider>
  );
}
